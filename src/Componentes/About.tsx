...
export const About = () => {
	const API_URL_UPCOMING = 'https://api.themoviedb.org/3/movie/upcoming?api_key=4810cdb903f6c99d9a2584aa26b24220&language=en-US&page=1';
	const API_URL_TOP_RATED_TV_SHOWS = 'https://api.themoviedb.org/3/tv/top_rated?api_key=4810cdb903f6c99d9a2584aa26b24220&language=en-US&page=1';
